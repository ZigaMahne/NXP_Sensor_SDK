...
void     LPI2C1_InitPins  (void) { /* Done in BOARD_InitI2C function */ }
...
int main (void) {
  ...
  NVIC_SetPriority(LPI2C1_IRQn,  8U);
  ...
  /* Clear pin GPIO GPIO_AD_B0_10 (Required with Sheild Board FRDM-K22F-A8974) */
  GPIO_PinWrite(GPIO1,  10U, 0U);
